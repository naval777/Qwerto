...
package com.naval.qwerto.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://qwerto-1036.appspot.com/_ah/api/";
   ...
   * @return the request
   */
  public Get get(java.lang.Long phone) throws java.io.IOException {
    Get result = new Get(phone);
    initialize(result);
    return result;
  }

  public class Get extends UserApiRequest<com.naval.qwerto.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Get(java.lang.Long phone) {
      super(UserApi.this, "GET", REST_PATH, null, com.naval.qwerto.backend.userApi.model.User.class);
    ...
    @com.google.api.client.util.Key("Phone")
    ...
    public Get setPhone(java.lang.Long phone) {
      this.phone = phone;
      return this;
    }
   ...
   *
   * @param content the {@link com.naval.qwerto.backend.userApi.model.User}
   * @return the request
   */
  public Insert insert(com.naval.qwerto.backend.userApi.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<com.naval.qwerto.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(com.naval.qwerto.backend.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.naval.qwerto.backend.userApi.model.User.class);
    }
  ...
  public class List extends UserApiRequest<com.naval.qwerto.backend.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.naval.qwerto.backend.userApi.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long phone, com.naval.qwerto.backend.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(phone, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.naval.qwerto.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long phone, com.naval.qwerto.backend.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.naval.qwerto.backend.userApi.model.User.class);
      this.phone = com.google.api.client.util.Preconditions.checkNotNull(phone, "Required parameter phone must be specified.");
    }
    ...
    public Patch setPhone(java.lang.Long phone) {
      this.phone = phone;
      return this;
    }
   ...
   * @return the request
   */
  public Remove remove(java.lang.Long phone) throws java.io.IOException {
    Remove result = new Remove(phone);
    initialize(result);
    return result;
  }
  ...
  public class Remove extends UserApiRequest<Void> {
     ...
     * @since 1.13
     */
    protected Remove(java.lang.Long phone) {
    ...
    public Remove setPhone(java.lang.Long phone) {
      this.phone = phone;
      return this;
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long phone, com.naval.qwerto.backend.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(phone, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.naval.qwerto.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long phone, com.naval.qwerto.backend.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.naval.qwerto.backend.userApi.model.User.class);
      this.phone = com.google.api.client.util.Preconditions.checkNotNull(phone, "Required parameter phone must be specified.");
    }
    ...
    public Update setPhone(java.lang.Long phone) {
      this.phone = phone;
      return this;
    }
